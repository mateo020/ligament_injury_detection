...
class CVAE(nn.Module):
    def __init__(self, feature_size, latent_size, position_size):
        super(CVAE, self).__init__()
        self.feature_size = feature_size
        self.class_size = position_size

        #encode 
        self.fc1 = nn.Linear(feature_size + position_size,400)
        self.fc21 = nn.Linear(400, latent_size)
        self.fc22 = nn.Linear(400, latent_size)

        #decode
        self.fc3 = nn.Linear(latent_size + position_size, 400)
    ...
    def encode(self,x,c): #Q(z| x,c)
        ...
        c: (bs, class_size)
        '''
        inputs = torch.cat([x,c],1) #(bs, feature + position)
